...
urlpatterns = [
    ...
    # ===== NOUVELLES ROUTES ENSEIGNANT (synchronisées) =====
    path('mes-modules/', views.mes_modules, name='mes_modules'),
    path('mes-modules/<int:module_id>/seance/creer/', views.creer_seance, name='creer_seance'),
    ...
    # ===== NOUVELLE ROUTE ÉTUDIANT (planning synchronisé) =====
